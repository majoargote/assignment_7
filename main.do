*** Min Education Regression Discontinuity (based on data from Oreopoulos 2006)
...
cd "C:\Users\majoa\OneDrive\Desktop\Learning\Grad School\econometrics\assignment_7"
*******************************************************************
* Question 1:
*******************************************************************


* 1.1 Replicate Table 1 Panel A and B and
